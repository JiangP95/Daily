原文:https://www.toutiao.com/i6800228333792526852/?tt_from=weixin&utm_campaign=client_share&wxshare_count=1&timestamp=1596386059&app=news_article&utm_source=weixin&utm_medium=toutiao_android&use_new_style=1&req_id=2020080300341901013105706938AEDF8F&group_id=6800228333792526852 
...
![面试高频点：关于消息队列的8大难题](./Reprint_MQ的8大难题_img/dcec6d042a554838bff13ae1135f53b9.png)
...
![面试高频点：关于消息队列的8大难题](./Reprint_MQ的8大难题_img/dfe94cf1de1b478485883371e7ddde06.png)
...
![面试高频点：关于消息队列的8大难题](./Reprint_MQ的8大难题_img/f105ed5591954f5ca90621799cb8ee53.jpg)
...
![面试高频点：关于消息队列的8大难题](./Reprint_MQ的8大难题_img/26c6d334c89a41ccbfb66ff303dd7733.png)
...
![面试高频点：关于消息队列的8大难题](./Reprint_MQ的8大难题_img/e20946f9c49c492f8acc379f1ded781e.png)



如果使用 MQ，每秒 5k 个请求写入 MQ，A 系统每秒钟最多处理 2k 个请求，因为 MySQL 每秒钟最多处理 2k 个。A 系统从 MQ 中慢慢拉取请求，每秒钟就拉取 2k 个请求，不要超过自己每秒能处理的最大请求数量就 ok，这样下来，哪怕是高峰期的时候，A 系统也绝对不会挂掉。而 MQ 每秒钟 5k 个请求进来，就 2k 个请求出去，结果就导致在中午高峰期（1 个小时），可能有几十万甚至几百万的请求积压在 MQ 中。

![面试高频点：关于消息队列的8大难题](./Reprint_MQ的8大难题_img/ec99ff5e93894817891889ec1d82f3ac.jpg)
...
- 系统可用性降低系统引入的外部依赖越多，越容易挂掉。本来你就是 A 系统调用 BCD 三个系统的接口就好了，ABCD 四个系统还好好的，没啥问题，你偏加个 MQ 进来，万一 MQ 挂了咋整？MQ 一挂，整套系统崩溃，你不就完了？如何保证消息队列的高可用，可以点击这里查看。
...
![面试高频点：关于消息队列的8大难题](./Reprint_MQ的8大难题_img/ddab10d185144b089e82e7b5e069136b.png)



![面试高频点：关于消息队列的8大难题](https://p6-tt.byteimg.com/origin/pgc-image/f0b3a4b62f4c498cb85450b239b6ef44?from=pc)
...
![面试高频点：关于消息队列的8大难题](./Reprint_MQ的8大难题_img/a309580a2ed646d39e17e0c16726bb46.png)



![面试高频点：关于消息队列的8大难题](./Reprint_MQ的8大难题_img/47d188cc67fe4f6ab4107f2bb8fee293.png)
...
![面试高频点：关于消息队列的8大难题](./Reprint_MQ的8大难题_img/21a40c6463f9448fa62e56cfdfc1ac3e.png)



![面试高频点：关于消息队列的8大难题](./Reprint_MQ的8大难题_img/47cf6bbf13f843cba1035ed2bd596be2.webp)
...
![面试高频点：关于消息队列的8大难题](./Reprint_MQ的8大难题_img/0184e85e9f9742ecb472926cad40713d.png)



Kafka 0.8 以后，提供了 HA 机制，就是 replica（复制品） 副本机制。每个 partition 的数据都会同步到其它机器上，形成自己的多个 replica 副本。所有 replica 会选举一个 leader 出来，那么生产和消费都跟这个 leader 打交道，然后其他 replica 就是 follower。写的时候，leader 会负责把数据同步到所有 follower 上去，读的时候就直接读 leader 上的数据即可。只能读写 leader？很简单，**要是你可以随意读写每个 follower，那么就要 care 数据一致性的问题**，系统复杂度太高，很容易出问题。Kafka 会均匀地将一个 partition 的所有 replica 分布在不同的机器上，这样才可以提高容错性。

![面试高频点：关于消息队列的8大难题](./Reprint_MQ的8大难题_img/0f0676ac398d4578af63e81caa80588b.png)



![面试高频点：关于消息队列的8大难题](./Reprint_MQ的8大难题_img/bb49dfb2e29540299af4fda1a90d3d5e.webp)
...
![面试高频点：关于消息队列的8大难题](./Reprint_MQ的8大难题_img/6115aa6c950c434982cd1478ef8c8463.png)



![面试高频点：关于消息队列的8大难题](./Reprint_MQ的8大难题_img/9534884f6e8548bda540a4efba3c92ce.webp)
...
![面试高频点：关于消息队列的8大难题](./Reprint_MQ的8大难题_img/d1b8ac2d9b1f40eb9510d768330bdaa7.webp)



![面试高频点：关于消息队列的8大难题](./Reprint_MQ的8大难题_img/0028b14c96e14390ad863f3116f2ce43.webp)



当然，如何保证 MQ 的消费是幂等性的，需要结合具体的业务来看。

## **四、如何保证消息的可靠性传输？或者说，如何处理消息丢失的问题？**
...
![面试高频点：关于消息队列的8大难题](./Reprint_MQ的8大难题_img/6498d9dc37b242c0b2960981e5771828.webp)



![面试高频点：关于消息队列的8大难题](./Reprint_MQ的8大难题_img/91cd1f3b95de4349b129b38a7f842b8b.webp)
...
事务机制和 confirm 机制最大的不同在于，**事务机制是同步的**，你提交一个事务之后会**阻塞**在那儿，但是confirm 机制是**异步**的，你发送个消息之后就可以发送下一个消息，然后那个消息 RabbitMQ 接收了之后会异步回调你的一个接口通知你这个消息接收到了。
...
![面试高频点：关于消息队列的8大难题](./Reprint_MQ的8大难题_img/706afec3ed974c3b8ef19a3e996e15fd.webp)
...
![面试高频点：关于消息队列的8大难题](./Reprint_MQ的8大难题_img/ac1264e9edb24bfdba56d47f70871d76.png)



![面试高频点：关于消息队列的8大难题](./Reprint_MQ的8大难题_img/587313bae64b477d93137883e6d74bde.png)
...
![面试高频点：关于消息队列的8大难题](./Reprint_MQ的8大难题_img/54f2475d16e94d8d968dc50e37f0cdf1.png)



![面试高频点：关于消息队列的8大难题](./Reprint_MQ的8大难题_img/82931867fb8740ab8f801cc8be279a75.png)
...
![面试高频点：关于消息队列的8大难题](./Reprint_MQ的8大难题_img/0c644d4a669b4af1b4547ff29eeb7316.png)



![面试高频点：关于消息队列的8大难题](./Reprint_MQ的8大难题_img/8fac55a7991f4354a315dd6450e9f7aa.jpg)
...
![面试高频点：关于消息队列的8大难题](./Reprint_MQ的8大难题_img/e70c92c655104295bcd4d780290dd448.webp)
...
**八、对于应用之间的调用，如何选择rpc还是mq？**

两个系统之间的调用，是选择rpc呢还是mq，说一下你们系统的选择吧

比如rpc可以是简单的spring httpinvoker，但是前提是都是java应用而且都是用spring framework，可以选择restful的web service或者是重量级的soap web service，或者是使用rmi，或者编写java api的socket程序；或者使用第三方成熟的soa产品，如alibaba的dubbo
