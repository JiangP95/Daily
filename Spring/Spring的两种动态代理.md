...
JDK动态代理和CGLIB字节码生成的区别？
 ...
 （2）CGLIB是针对`类`实现代理，主要是对指定的类生成一个子类，覆盖其中的方法
...
![img](https:////upload-images.jianshu.io/upload_images/1527003-4fe50b2db8db2573.png?imageMogr2/auto-orient/strip|imageView2/2/w/837/format/webp)
...
![img](https:////upload-images.jianshu.io/upload_images/1527003-a887ee54fea90200.png?imageMogr2/auto-orient/strip|imageView2/2/w/846/format/webp)
